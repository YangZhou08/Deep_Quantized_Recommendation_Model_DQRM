...
print("estimated model size without MLP quantization is {}".format(emb_param * 0.5 + lin_param * 4)) 
print("estimated model size with MLP quantization is {}".format(emb_param * 0.5 + lin_param * 0.5)) 
