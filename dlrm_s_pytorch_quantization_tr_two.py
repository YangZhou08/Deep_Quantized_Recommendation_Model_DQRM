...
import extend_distributed_three as ext_dist_two # NOTE only here to reduce modifications 
...
def run(): 
    ...
    ext_dist_two.init_distributed(local_rank = args.local_rank, use_gpu = use_gpu, backend = args.dist_backend) 

    # get the rank defined here 
